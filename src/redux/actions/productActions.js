...
export const getAllProducts = (addToast) => {
  return async (dispatch) => {
    try {
      const response = await axios.get("https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/customer/product/list-product-by-customer", {
        headers: {
  ...
  return async (dispatch) => {
    try {
      ...
      const response = await axios.get(
        "https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/customer/product/search-product",
        { params }, {
          headers: {
            'Content-Type': 'application/json',
...
export const getProductBestSeller = (addToast, top) => {
  return async (dispatch) => {
    try {
      ...
      const url = 'https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/customer/product/get-product-best-seller/{Top}?top=' + top;
...
export const getNewProduct = (addToast) => {
  return async (dispatch) => {
    try {
      const response = await axios.get(`https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/customer/product/new-product`,{
        headers: {
          'Content-Type': 'application/json',
...
export const getFeatureProduct = (addToast) => {
  return async (dispatch) => {
    try {
      const response = await axios.get(`https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/customer/product/get-product-feature-true`,{
        headers: {
          'Content-Type': 'application/json',
...
export const getProductImages = (productID) => {
  return async (dispatch) => {
    try {
      const response = await axios.get(`https://bloomgift2-hkdra9cyapase2cy.southeastasia-01.azurewebsites.net/api/product-images/${productID}/images`,{
        headers: {
          'Content-Type': 'application/json',
